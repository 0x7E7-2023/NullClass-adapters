(function () {
    ...
    // 无从谈起 —— 上游注释与批次文档都写「树维 eams」，但脚本本身给不出接口证据。
    ...
    //
    // ⚠️ 厂商名订正（2026-09-16，批次四）：此前写「强智 eams」，是错的。/eams/ 是
    // **上海树维信息科技有限公司（SupWisdom）**的产品，不是湖南强智科技的。证据见
    // jw-adapters/masu/extract.js 文件头。只改说明文字，算法一行未动。
    //
    // 移植改动：
